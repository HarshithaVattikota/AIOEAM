...
if($_SESSION['login_type'] != 1)
  $twhere = "  ";
?>
<div style="background-image: url('Aioeambackground.jpg');">
<!-- Info boxes -->
 <div class="col-12">
          <div class="card">
            <div class="card-body">
                ...
                $row['status'] = 4;
                  ...
                  <tr>
                      ...
                      <td>
                        ...
                        <a class="delete_user btn btn-outline-danger btn-sm mt-3" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>
                              <i class="fas fa-folder">
                              </i>
                              Delete
                        </a>
...
<script>
	...
	_conf("Are you sure to delete this Project?","delete_user",[$(this).attr('data-id')])
	})
	})
